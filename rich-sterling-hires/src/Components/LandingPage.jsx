    ...
    return (
        <div>
                    ...
                    <Slider className='xl:mx-[90px] mx-0' {...settings}>
                        <div className='py-5'>
                            <div className='flex md:flex-row flex-col items-center justify-center md:justify-between 2xl:justify-center xl:mt-20 md:mt-10 md:px-16 px-5 gap-5 w-full'>
                                ...
                                <div className=''>
                                    <img className='lg:w-[330px] w-[280px] h-[450px] lg:h-[500px]' src={video} alt="" />
                                </div>
                ...
                <div className='flex mp:flex-row flex-col items-center w-full mp:gap-10'>
                    <div className='mt-10 mp:w-[50%]'>
                        ...
                        <div className='flex items-center sa:flex-row flex-col xl:mt-[-30px] mt-5 xl:gap-10 sa:gap-5'>
                            <p data-aos='fade-up' data-aos-delay='900' className='font-medium xl:text-[110px] text-[80px] text-[#cddbf0]'>03</p>
                            <div data-aos='fade-up' data-aos-delay='1100' className='flex gap-4 items-center rounded-[20px] w-full mp:w-[430px] shadow-[0_10px_30px_rgba(0,0,0,0.2)] shadow-[#c9d6e8] xl:p-5 p-3'>
                        ...
                        <div className='flex items-center sa:flex-row flex-col-reverse xl:mt-[-30px] mt-5 xl:gap-10 sa:gap-5'>
                            <div data-aos='fade-up' data-aos-delay='1500' className='flex gap-4 items-center rounded-[20px] w-full mp:w-[430px] shadow-[0_10px_30px_rgba(0,0,0,0.2)] shadow-[#c9d6e8] xl:p-5 p-3'>
                            ...
                            <p data-aos='fade-up' data-aos-delay='1300' className='font-medium xl:text-[110px] text-[80px] text-[#cddbf0]'>04</p>
                        </div>
                    </div>
            ...
            <div className='sm:px-[90px] overflow-hidden px-5 py-10'>
                ...
                <div className='flex w-full justify-center flex-wrap gap-5 mt-10'>
                    <div data-aos='zoom-in' data-aos-delay='300' className='flex flex-col gap-5 items-center w-full mq:w-[48%] lg:w-[30%]'>
                        <div className='rounded-[20px] py-6 px-2 shadow-[0_1px_20px_rgba(0,0,0,0.2)]  shadow-[#002b6b53] flex flex-col items-center gap-4'>
                            ...
                            <p className='font-normal text-[16px] text-center'>
                                Working with Rich Sterling Hires transformed our development capabilities. We added five senior developers
                                at less than the cost of two in San Francisco. The quality of work has been outstanding, and the ROI
                                is simply unmatched.
                            </p>
            ...
            <div id='pricing' className='lg:px-[50px] overflow-hidden xl:px-[90px] mp:px-5 md:px-[90px] px-7 py-10'>
                <div data-aos='zoom-in' data-aos-delay='300' className='font-semibold text-[33px] leading-10 items-center justify-center text-[#002B6B] flex flex-wrap gap-1'>
                ...
                <div className='flex mp:flex-row flex-col items-center justify-between gap-10 mp:mt-20'>
                    <div className='flex flex-col gap-20 mp:w-[60%] 2xl:w-full mt-[75px]'>
                        ...
                        <div className='flex sk:flex-row flex-col items-center gap-16'>
                            <div>
                                <div data-aos='fade-up' data-aos-delay='1400' className='flex items-start gap-1'>
                                    <FaCheck className='text-[#0066FF] text-[24px]' />
                                    <p className='text-[19px] font-medium'>Access to Vetted Talent</p>
                                </div>
                                <p data-aos='fade-up' data-aos-delay='1700' className='text-[19px] font-normal'>Top 2% of candidates across Africa in tech, design, marketing, and operations roles.</p>
                            </div>
                            <div>
                                <div data-aos='fade-up' data-aos-delay='2000' className='flex items-start gap-1'>
                                    <FaCheck className='text-[#0066FF] text-[24px]' />
                                    <p className='text-[19px] font-medium'>End-to-End Admin Support</p>
                                </div>
                                <p data-aos='fade-up' data-aos-delay='2300' className='text-[19px] font-normal'>We handle the contracts, time tracking, and local compliance so you don’t have to.</p>
                            </div>
                        </div>
                    </div>
                    <div data-aos='fade-down' data-aos-delay='2000' className='bg-[#0066FF] shadow-lg shadow-black/30 text-white rounded-[20px] p-5 font-manrope'>
            ...
            <div className='lg:px-[60px] overflow-hidden px-5 pt-12'>
                ...
                <div>
                    <div className='grid mq:grid-cols-2 justify-center lg:gap-5 gap-3 mt-14 font-manrope'>
                        ...
                        <div data-aos='zoom-in' data-aos-delay='600' className='bg-[#EDEEF0] border-[#AAAAAA] border rounded-[20px] shadow-[0_1px_20px_rgba(0,0,0,0.2)]  shadow-[#002b6b53] p-5 flex mp:flex-row flex-col mp:items-start gap-4'>
                            <div className='flex justify-between items-center'>
                        ...
                        <div data-aos='zoom-in' data-aos-delay='800' className='bg-[#EDEEF0] border-[#AAAAAA] border rounded-[20px] shadow-[0_1px_20px_rgba(0,0,0,0.2)]  shadow-[#002b6b53] p-5 flex mp:flex-row flex-col mp:items-start gap-4'>
                            <div className='flex justify-between items-center'>
                        ...
                        <div data-aos='zoom-in' data-aos-delay='1000' className='bg-[#EDEEF0] border-[#AAAAAA] border rounded-[20px] shadow-[0_1px_20px_rgba(0,0,0,0.2)]  shadow-[#002b6b53] p-5 flex mp:flex-row flex-col mp:items-start gap-4'>
                            <div className='flex justify-between items-center'>
                        ...
                        <div data-aos='zoom-in' data-aos-delay='1200' className='bg-[#EDEEF0] border-[#AAAAAA] border rounded-[20px] shadow-[0_1px_20px_rgba(0,0,0,0.2)]  shadow-[#002b6b53] p-5 flex mp:flex-row flex-col mp:items-start gap-4'>
                            <div className='flex justify-between items-center'>
